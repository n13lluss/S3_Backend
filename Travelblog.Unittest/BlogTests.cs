    ...
    namespace Travelblog.Unittest
    {
        ...
        [Fact]
            public async Task CreateBlog_NullBlog_ThrowsArgumentNullException()
            {
                // Arrange
                var blogRepositoryMock = new Mock<IBlogRepository>();
                var blogPostRepositoryMock = new Mock<IBlogPostRepository>();
            ...
            // Act and Assert
            await Assert.ThrowsAsync<ArgumentNullException>(() => blogService.CreateBlog(null));
            }

            [Fact]
            public async Task CreateBlog_EmptyTitle_ThrowsArgumentException()
            {
                // Arrange
                var blogRepositoryMock = new Mock<IBlogRepository>();
                var blogPostRepositoryMock = new Mock<IBlogPostRepository>();
                ...
                // Act and Assert
                await Assert.ThrowsAsync<ArgumentException>(() => blogService.CreateBlog(invalidBlog));
            }
        ...
        public async Task GetBlogWithPosts_ValidId_ReturnsBlogWithPosts()
        {
            ...
            blogPostRepositoryMock.Setup(repo => repo.GetAllBlogPostsAsync(It.IsAny<int>()))
                                 .ReturnsAsync(posts);
        ...
        [Fact]
            ...
            public async Task GetBlogList_EmptyData_ThrowsException()
            {
                ...
                // Act and Assert
                Assert.ThrowsAsync<Exception>(() => blogService.GetBlogList());
            }
        }
    }
